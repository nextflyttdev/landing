          ...
          <div className=" md:col-span-4 lg:col-span-5">
            ...
            <div className="mt-6">
              <p className=" text-sm  ">
                ...
                jobbet utförs säkert, effektivt och utan skador – även i trappor
                och trånga passager. Med GoFlytt får du en trygg och smidig
                tjänst som sparar både tid och rygg. Vi bär – du slipper.
              </p>
            </div>
            <div className="">
              <img
