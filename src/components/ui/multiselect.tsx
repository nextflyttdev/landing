      ...
      >
        <PopoverTrigger asChild className="w-full">
          <Button
            ...
            className={cn(
              "flex w-full  min-h-14  h-max text-base p-1 rounded-md border  items-center justify-between bg-white hover:bg-white [&_svg]:pointer-events-auto shadow-sm",
              className,
            )}
          >
            {selectedValues.length > 0 ? (
                ...
                <div className="flex flex-wrap items-center  ">
                  ...
                  {selectedValues.length > maxCount && (
                    <Badge
                      ...
                      style={{ animationDuration: `${animation}s` }}
                    >
                      {`+ ${selectedValues.length - maxCount} fler`}
                      <XCircle
                        className="ml-2 h-4 w-4 cursor-pointer"
                        onClick={(event) => {
                          event.stopPropagation();
              ...
              <div className="flex items-center justify-between w-full mx-auto">
                <span className="text-base text-muted-foreground mx-3 font-normal">
                  {placeholder}
                </span>
        ...
        >
          <Command>
            ...
            <CommandList>
              <CommandEmpty>Inga resultat hittade</CommandEmpty>
              <CommandGroup>
                <CommandItem
                  key="all"
                  onSelect={toggleAll}
